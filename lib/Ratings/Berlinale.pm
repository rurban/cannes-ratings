...
#    my $l = $title{$t}->{line};
#    next if $title{$t}->{section} =~ /^(Retrospektive|Panorama 40|Forum 50|Predictions|Perspektive Gast|Perspektive Match)$/;
#    next if $l =~ / 19\d\d\)$/;
#    next if $l =~ / 200\d\)$/;
